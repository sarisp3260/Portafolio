...
const Work = () => {
  return (
    <>
      <Link to={"/"}>
        <div className='flex flex-col items-center justify-center gap-3 bg-gray/90 rounded-md transform hover:scale-95 transition ease-out duration-700'>
          ...
          <div className="descrip flex justify-center md:justify-between flex-wrap text-black py-2 px-4 w-full">
              ...
              <span className='max-w-full break-words text-base md:text-xl'>Text</span>
          </div>
